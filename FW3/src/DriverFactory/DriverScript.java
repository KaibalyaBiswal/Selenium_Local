...
try{
   ...
   driver = FunctionLibrary.startBrowser(driver);
        ...
        excel.setDate(TCModule, j, 5, "pass");
            ModuleStatus="true";    
		...
		{
		excel.setDate(TCModule, j, 5, "Fail");
		...
		excel.setDate("MasterTestCases", i, 3, "pass");
	
		}
		else
		{
		excel.setDate("MasterTestCases", i, 3, "fail");	
		}
		}
		
		else
		{
		excel.setDate("MasterTestCases", i, 3, "not executed");	
